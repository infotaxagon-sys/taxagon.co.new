    ...
    <div className="overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="rounded-3xl overflow-hidden shadow-brand aspect-[4/3]">
              <img src="https://images.unsplash.com/photo-1524492412937-b28074a5d7da?auto=format&fit=crop&w=1000&q=75" alt="The Taj Mahal reflected in its front pool, India" className="w-full h-full object-cover" />
            </div>
          </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 bg-indigo-deep">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-indigo-100 mb-8">Expert NRI cross-border tax compliance — US + India, seamlessly handled.</p>
