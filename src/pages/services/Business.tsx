        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="rounded-3xl overflow-hidden shadow-brand aspect-[4/3]">
              <img src="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1000&q=75" alt="Business partners celebrating a completed company filing" className="w-full h-full object-cover" />
            </div>
          </motion.div>
          </div>
        </div>
