...
const STUB_RESPONSES = [
  ...
  "Great question! Taxagon offers individual, business, FBAR, and NRI tax services starting at $99. Would you like to learn more about a specific service?",
...
export async function sendMessageToGemini(prompt: string): Promise<string> {
  ...
  if (lower.includes('price') || lower.includes('cost') || lower.includes('pricing')) {
    return "Our individual filing starts at $99. Business returns are custom-quoted. Check our Pricing page for the full fee schedule, or book a free strategy session!"
  }
